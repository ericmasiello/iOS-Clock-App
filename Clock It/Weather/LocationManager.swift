...
struct GPSCoordinateNormalizer {
  ...
  struct NormalizedCoordinate {
    ...
    func isDifferent(from other: NormalizedCoordinate, milesThreshold: CLLocationDistance = 5.0) -> Bool {
  ...
  static func normalize(latitude: CLLocationDegrees, longitude: CLLocationDegrees) -> NormalizedCoordinate {
...
final class LocationManager: NSObject, ObservableObject, CLLocationManagerDelegate {
  ...
  @Published var coordinates: (latitude: Double, longitude: Double)? {
    didSet {
      ...
      let normalizedOldCoords = GPSCoordinateNormalizer.normalize(latitude: previousCoords.latitude, longitude: previousCoords.longitude)
      let normalizednewCoords = GPSCoordinateNormalizer.normalize(latitude: newCoords.latitude, longitude: newCoords.longitude)
